...
ACTIVE_PRODUCTS = [
    ProductMetadata(
        ...
        features=[
            {'label':_('Max feeds:'), 'value':_('1~5')},
            {'label':_('Max users:'), 'value':_('3')},
            {'label':_('Custom feeds:'), 'value':_('FASLE')},
            {'label':_('Custom observables:'), 'value':_('FALSE')},
            {'label':_('API access:'), 'value':_('FASLE')},
        ],
    ),
    ProductMetadata(
        ...
        is_default=True,
        features=[
            {'label':_('Max feeds:'), 'value':_('10~50')},
            {'label':_('Max users:'), 'value':_('20')},
            {'label':_('Custom feeds:'), 'value':_('TRUE')},
            {'label':_('Custom observables:'), 'value':_('FALSE')},
            {'label':_('API access:'), 'value':_('FASLE')},
        ],
    ),
    ProductMetadata(
        ...
        description=_('For small businesses and teams'),
        features=[
            {'label':_('Max feeds:'), 'value':_('200')},
            {'label':_('Max users:'), 'value':_('100')},
            {'label':_('Custom feeds:'), 'value':_('TRUE')},
            {'label':_('Custom observables:'), 'value':_('TRUE')},
            {'label':_('API access:'), 'value':_('TRUE')},
        ],
    ),
]
