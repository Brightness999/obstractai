"""
Django settings for cyobstract project.
...
SECRET_KEY = 'AVQicnKABJpqfYEoOSyxzqhYLjQJgXHEKCEoQwjV'
...
WSGI_APPLICATION = 'cyobstract.wsgi.application'
...
ADMINS = [('Karen', 'kardzavaryan@gmail.com')]
