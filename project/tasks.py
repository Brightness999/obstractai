                        ...
                        if(item == 'title'):
                            ...
                            for result in results:
                                if result == 'ipv4addr' and len(results[result])>0:
                                    ...
                                    if result.strip() != '' and len(GlobalIndicators.objects.filter(value_api=result).all()) == 0:
                                        globalindicator = GlobalIndicators.objects.create(type='Analysis', type_api='analysis', value='Filepath', value_api=result)
