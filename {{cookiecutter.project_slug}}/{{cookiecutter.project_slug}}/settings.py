...
SECRET_KEY = '{{ random_ascii_string(40) }}'
...
PROJECT_APPS = [
{% if cookiecutter.use_subscriptions == 'y' %}    'apps.subscriptions.apps.SubscriptionConfig',{% endif %}
...
{% if cookiecutter.use_teams == 'y' %}ACCOUNT_ADAPTER = 'apps.teams.adapter.AcceptInvitationAdapter'{% else %}ACCOUNT_ADAPTER = 'apps.users.adapter.EmailAsUsernameAdapter'{% endif %}
...
PROJECT_METADATA = {
    ...
    'URL': 'http://{{cookiecutter.domain_name}}',
