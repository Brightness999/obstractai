...
{% if cookiecutter.use_subscriptions == 'y' %}    path('subscriptions/', include('apps.subscriptions.urls')),{% endif %}
...
{% if cookiecutter.use_subscriptions == 'y' %}    # djstripe urls - for webhooks
    path("stripe/", include("djstripe.urls", namespace="djstripe")),{% endif %}
